...
WebUI.sendKeys(findTestObject('Create Playlist/Change name from playlist title/input_Name_text-input-eb4af98c49bba7d1'), 
    Keys.chord(Keys.BACK_SPACE))

WebUI.delay(1)

WebUI.click(findTestObject('Create Playlist/Change name from playlist title/span_Save'))

WebUI.delay(1)

WebUI.verifyTextPresent('Playlist name is required.', true)
