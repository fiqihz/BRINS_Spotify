...
WebUI.mouseOver(findTestObject('Create Playlist/Playlist Menu/span_Share'))

WebUI.click(findTestObject('Create Playlist/Playlist Menu/span_Copy Spotify URI'))

WebUI.delay(2)

WebUI.verifyTextPresent('Link copied to clipboard', true)
