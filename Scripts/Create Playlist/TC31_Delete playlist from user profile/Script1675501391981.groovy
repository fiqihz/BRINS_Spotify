...
if (WebUI.verifyTextPresent("Remove from profile", true, FailureHandling.OPTIONAL)) {
	WebUI.click(findTestObject('Create Playlist/Playlist Menu/span_Remove from profile'))
	WebUI.delay(2)
	WebUI.verifyTextPresent('Playlist is no longer displayed on your profile.', true)
}
