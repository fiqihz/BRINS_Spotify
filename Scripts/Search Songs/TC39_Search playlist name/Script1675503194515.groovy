...
WebUI.setText(findTestObject('Search Playlist/input__Type__TypeElement-sc-goli3j-0 hGXzYa QO9loc33XC50mMRUCIvf'), 'Indonesia')

WebUI.delay(1)

WebUI.verifyTextNotPresent('Please make sure your words are spelled correctly or use less or different keywords.', true)

WebUI.click(findTestObject('Search Playlist/span_Playlists'))
